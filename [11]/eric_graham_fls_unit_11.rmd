...
plot(maxtemp_1990_to_2016, main = "Historical Temperature Maximum Temperatures (1990-2016)",
...
plot(ses_fit, main = "SES Forecast for Maximum Temperatures (1990-2021)",
     ylab = "Temperature (°C)", xlab = "Year", col = "black")
...
plot(holt_fit, main = "Holt's Damped Forecast for Maximum Temperatures (1990-2021)",
     ylab = "Temperature (°C)", xlab = "Year", col = "black")
